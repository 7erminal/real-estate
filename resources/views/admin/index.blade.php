...
<body>
        ...
        <div class="content mt-3">
            ...
            <div class="col-sm-12">
                <div class="alert  alert-success alert-dismissible fade show" role="alert">
                    <span class="badge badge-pill badge-success">Success</span> You successfully logged in. {{Auth::user()->name}}
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="card text-white bg-flat-color-1">
                    <div class="card-body pb-0">
                        ...
                        <p class="text-light">Total Number of requests</p>
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="card text-white bg-flat-color-2">
                    <div class="card-body pb-0">
                        ...
                        <h4 class="mb-0">
                            <span class="count">{{ $data['count']->quantity }}</span>
                        </h4>
                        <p class="text-light">Number of items sold</p>
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="card text-white bg-flat-color-3">
                    <div class="card-body pb-0">
                        ...
                        <h4 class="mb-0">
                            <span class="count">{{ $data['count']->total_price }}</span>
                        </h4>
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="card text-white bg-flat-color-4">
                    <div class="card-body pb-0">
                        ...
                        <h4 class="mb-0">
                            <span class="count">{{ $data['customers']->numberofcustomers }}</span>
                        </h4>
                        <p class="text-light">Number of customers</p>
    ...
    <script src="{{ URL::asset('admin/vendors/chart.js/dist/Chart.bundle.min.js') }}"></script>
    <script src="{{ URL::asset('admin/assets/js/dashboard.js') }}"></script>
    <script src="{{ URL::asset('admin/assets/js/widgets.js') }}"></script>
    <script src="{{ URL::asset('admin/vendors/jqvmap/dist/jquery.vmap.min.js') }}"></script>
